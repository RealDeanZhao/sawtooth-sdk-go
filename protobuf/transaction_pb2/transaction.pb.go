...
func (*TransactionHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_6576c68d0d891c1f, []int{0}
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_6576c68d0d891c1f, []int{1}
}
...
func (*TransactionList) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_6576c68d0d891c1f, []int{2}
}
...
func init() {
	proto.RegisterFile("github.com/hyperledger/sawtooth-sdk-go/protobuf/transaction_pb2/transaction.proto", fileDescriptor_transaction_6576c68d0d891c1f)
}

var fileDescriptor_transaction_6576c68d0d891c1f = []byte{
