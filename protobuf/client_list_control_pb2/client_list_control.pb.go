...
func (*ClientPagingControls) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_list_control_ba2ec42a3efeeb7c, []int{0}
}
...
func (*ClientPagingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_list_control_ba2ec42a3efeeb7c, []int{1}
}
...
func (*ClientSortControls) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_list_control_ba2ec42a3efeeb7c, []int{2}
}
...
func init() {
	proto.RegisterFile("github.com/hyperledger/sawtooth-sdk-go/protobuf/client_list_control_pb2/client_list_control.proto", fileDescriptor_client_list_control_ba2ec42a3efeeb7c)
}

var fileDescriptor_client_list_control_ba2ec42a3efeeb7c = []byte{
