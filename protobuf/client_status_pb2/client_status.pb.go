...
func (ClientStatusGetResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_client_status_3cb6ac490eacc2a0, []int{1, 0}
}
...
func (*ClientStatusGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_status_3cb6ac490eacc2a0, []int{0}
}
...
func (*ClientStatusGetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_status_3cb6ac490eacc2a0, []int{1}
}
...
func init() {
	proto.RegisterFile("github.com/hyperledger/sawtooth-sdk-go/protobuf/client_status_pb2/client_status.proto", fileDescriptor_client_status_3cb6ac490eacc2a0)
}

var fileDescriptor_client_status_3cb6ac490eacc2a0 = []byte{
