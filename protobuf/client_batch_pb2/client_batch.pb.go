...
func (ClientBatchListResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_client_batch_31b9fcaea5f50d35, []int{1, 0}
}
...
func (ClientBatchGetResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_client_batch_31b9fcaea5f50d35, []int{3, 0}
}
...
func (*ClientBatchListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_batch_31b9fcaea5f50d35, []int{0}
}
...
func (*ClientBatchListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_batch_31b9fcaea5f50d35, []int{1}
}
...
func (*ClientBatchGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_batch_31b9fcaea5f50d35, []int{2}
}
...
func (*ClientBatchGetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_batch_31b9fcaea5f50d35, []int{3}
}
...
func init() {
	proto.RegisterFile("github.com/hyperledger/sawtooth-sdk-go/protobuf/client_batch_pb2/client_batch.proto", fileDescriptor_client_batch_31b9fcaea5f50d35)
}

var fileDescriptor_client_batch_31b9fcaea5f50d35 = []byte{
