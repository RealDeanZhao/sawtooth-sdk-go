...
func (StateChange_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_transaction_receipt_fa2f8cf67cdf47a0, []int{1, 0}
}
...
func (*TransactionReceipt) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_receipt_fa2f8cf67cdf47a0, []int{0}
}
...
func (*StateChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_receipt_fa2f8cf67cdf47a0, []int{1}
}
...
func (*StateChangeList) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_receipt_fa2f8cf67cdf47a0, []int{2}
}
...
func init() {
	proto.RegisterFile("github.com/hyperledger/sawtooth-sdk-go/protobuf/transaction_receipt_pb2/transaction_receipt.proto", fileDescriptor_transaction_receipt_fa2f8cf67cdf47a0)
}

var fileDescriptor_transaction_receipt_fa2f8cf67cdf47a0 = []byte{
