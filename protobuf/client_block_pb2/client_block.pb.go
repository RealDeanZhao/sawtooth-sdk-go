...
import fmt "fmt"
import math "math"
import block_pb2 "github.com/hyperledger/sawtooth-sdk-go/protobuf/block_pb2"
...
func (ClientBlockListResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_client_block_8baf750a983a4fdb, []int{1, 0}
}
...
func (ClientBlockGetResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_client_block_8baf750a983a4fdb, []int{6, 0}
}
...
func (*ClientBlockListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_block_8baf750a983a4fdb, []int{0}
}
...
func (*ClientBlockListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_block_8baf750a983a4fdb, []int{1}
}
...
func (*ClientBlockGetByIdRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_block_8baf750a983a4fdb, []int{2}
}
...
func (*ClientBlockGetByNumRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_block_8baf750a983a4fdb, []int{3}
}
...
func (*ClientBlockGetByTransactionIdRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_block_8baf750a983a4fdb, []int{4}
}
...
func (*ClientBlockGetByBatchIdRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_block_8baf750a983a4fdb, []int{5}
}
...
func (*ClientBlockGetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_block_8baf750a983a4fdb, []int{6}
}
...
func init() {
	proto.RegisterFile("github.com/hyperledger/sawtooth-sdk-go/protobuf/client_block_pb2/client_block.proto", fileDescriptor_client_block_8baf750a983a4fdb)
}

var fileDescriptor_client_block_8baf750a983a4fdb = []byte{
