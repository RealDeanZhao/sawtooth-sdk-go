...
import fmt "fmt"
import math "math"
import transaction_receipt_pb2 "github.com/hyperledger/sawtooth-sdk-go/protobuf/transaction_receipt_pb2"
...
func (ClientReceiptGetResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_client_receipt_ddf95dd6b4abee6a, []int{1, 0}
}
...
func (*ClientReceiptGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_receipt_ddf95dd6b4abee6a, []int{0}
}
...
func (*ClientReceiptGetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_client_receipt_ddf95dd6b4abee6a, []int{1}
}
...
func init() {
	proto.RegisterFile("github.com/hyperledger/sawtooth-sdk-go/protobuf/client_receipt_pb2/client_receipt.proto", fileDescriptor_client_receipt_ddf95dd6b4abee6a)
}

var fileDescriptor_client_receipt_ddf95dd6b4abee6a = []byte{
