...
func (*BatchHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_batch_767b90462be83eb8, []int{0}
}
...
func (*Batch) Descriptor() ([]byte, []int) {
	return fileDescriptor_batch_767b90462be83eb8, []int{1}
}
...
func (*BatchList) Descriptor() ([]byte, []int) {
	return fileDescriptor_batch_767b90462be83eb8, []int{2}
}
...
func init() {
	proto.RegisterFile("github.com/hyperledger/sawtooth-sdk-go/protobuf/batch_pb2/batch.proto", fileDescriptor_batch_767b90462be83eb8)
}

var fileDescriptor_batch_767b90462be83eb8 = []byte{
