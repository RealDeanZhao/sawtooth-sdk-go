...
import fmt "fmt"
import math "math"
import transaction_pb2 "github.com/hyperledger/sawtooth-sdk-go/protobuf/transaction_pb2"
...
func (TpRegisterResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processor_7904677090a3ff75, []int{1, 0}
}
...
func (TpUnregisterResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processor_7904677090a3ff75, []int{3, 0}
}
...
func (TpProcessResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processor_7904677090a3ff75, []int{5, 0}
}
...
func (*TpRegisterRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_processor_7904677090a3ff75, []int{0}
}
...
func (*TpRegisterResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_processor_7904677090a3ff75, []int{1}
}
...
func (*TpUnregisterRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_processor_7904677090a3ff75, []int{2}
}
...
func (*TpUnregisterResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_processor_7904677090a3ff75, []int{3}
}
...
func (*TpProcessRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_processor_7904677090a3ff75, []int{4}
}
...
func (*TpProcessResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_processor_7904677090a3ff75, []int{5}
}
...
func init() {
	proto.RegisterFile("github.com/hyperledger/sawtooth-sdk-go/protobuf/processor_pb2/processor.proto", fileDescriptor_processor_7904677090a3ff75)
}

var fileDescriptor_processor_7904677090a3ff75 = []byte{
